...
namespace KDramaSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251029203358_AdicionarTabelaPlaylists")]
    partial class AdicionarTabelaPlaylists
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KDramaSystem.Domain.Entities.Badge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KDramaSystem.Domain.Entities.BadgeConquista", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KDramaSystem.Domain.Entities.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("KDramaSystem.Domain.Entities.Atividade", b =>
                {
                    b.HasOne("KDramaSystem.Domain.Entities.Usuario", "Usuario")
                        .WithMany("Atividades")
